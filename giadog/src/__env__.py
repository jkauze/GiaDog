...
ANGULAR_VEL_NOISE    : float       = SIM["ANGULAR_VEL_NOISE"]
ORIENTATION_NOISE    : float       = SIM["ORIENTATION_NOISE"]
VELOCITY_NOISE       : float       = SIM["VELOCITY_NOISE"]
ACCELERATION_NOISE   : float       = SIM["ACCELERATION_NOISE"]
JOINT_ANGLE_NOISE    : float       = SIM["JOINT_ANGLE_NOISE"]
JOINT_VELOCITY_NOISE : float       = SIM["JOINT_VELOCITY_NOISE"]
...
ACTOR_UPDATE_STEPS   : int   = TRAIN["ACTOR_UPDATE_STEPS"]
CRITIC_UPDATE_STEPS  : int   = TRAIN["CRITIC_UPDATE_STEPS"]
TRAIN_CRITIC_ITERS   : float = TRAIN["TRAIN_CRITIC_ITERS"]
BACKTRACK_ITERS      : float = TRAIN["BACKTRACK_ITERS"]
