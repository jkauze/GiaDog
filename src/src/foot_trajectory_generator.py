...
def calculate_foot_trajectories(
    ...
    """
        ...
        ----------
            ...
            sigma_0: numpy.ndarray, shape(4,), optional
                Initial foots phases. Values are in radians between 0 and 2pi.
                Default: numpy.array([0,numpy.pi/2,numpy.pi,1.5 *numpy.pi])

            Hi_z :-> numpy.ndarray, shape(3,), optional
                i-th leg horizontal frame z component. Must be parallel to the 
                gravity vector.
                Default: numpy.array([0,0,1])
