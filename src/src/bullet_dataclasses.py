...
class ContactInfo:
    ...
    contactNormalOnB:list #vec3, list of 3 float// contact normal on B, pointing towards A
    ...
    lateralFrictionDir1:list #vec3, list of 3 floats // first lateral friction direction
    
    lateralFriction2:float   #lateral friction force in the lateralFrictionDir2 direction
    lateralFrictionDir2:list #vec3, list of 3 floats// second lateral friction direction
