...
class ARS_Agent():
	...
	def save_weights(self, name = str(datetime.now()))  :
		"""
		F: Saves the agents weights θ into a .npy file. If unspecesified the file name is the current data and time.
		"""

		np.save('{}.npy'.format(name), self.θ)
	
	def load_weights(self, name)  :
		"""
		name: File path to and npy file. Example: "weights.npy"
		"""
